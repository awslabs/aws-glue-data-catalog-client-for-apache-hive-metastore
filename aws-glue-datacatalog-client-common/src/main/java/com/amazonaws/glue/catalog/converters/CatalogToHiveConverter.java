...
public class CatalogToHiveConverter {
  ...
  public static List<ColumnStatisticsObj> convertColumnStatisticsList(final List<ColumnStatistics> catatlogColumnStatisticsList) {
  ...
  private static ColumnStatisticsData convertColumnStatisticsData(
  ...
  private static Decimal convertDecimal(com.amazonaws.services.glue.model.DecimalNumber catalogDecimal) {
